"""
End-to-end tests for splent_feature_about.
...
Run with:  splent feature:test splent_feature_about --e2e
"""
...
def test_index_page_loads(browser):
    ...
    browser.get(f"{host}/splent_feature_about")
    assert "splent_feature_about" in browser.page_source.lower()
